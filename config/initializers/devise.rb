...
Devise.setup do |config|
  ...
  config.mailer_sender = Rails.application.credentials[:system_email]
  ...
  config.unlock_keys = %i[email username login]
  ...
  config.warden do |manager|
    manager.failure_app = DeviseFailureService
  end
